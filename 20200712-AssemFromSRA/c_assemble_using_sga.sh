...
#
# The only argument this script takes is the overlap length used for the final contig assembly.
#
...
IN1=${PWD}/UV/b_fastq/ERR3283546.sra_1.fastq
IN2=${PWD}/UV/b_fastq/ERR3283546.sra_2.fastq

# Parameters
SGA_BIN=${PWD}/../20200609-Tools/sga/local/bin/sga
SGA_SRC=${PWD}/../20200609-Tools/sga/sga/src
